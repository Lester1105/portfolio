...
const About = ({isDarkMode}) => {
  return (
    ...
    id="about" className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        className='flex w-ful flex-col lg:flex-row items-center gap-20 my-20'>
            <motion.div
        ...
        transition={{duration: 0.6,delay: 0.8}}
            className='flex-1'>
                ...
                >I'm a self-taught front-end developer with a background in quality control,
                     now focused on building modern, responsive websites.
                     I enjoy transforming ideas into functional and visually appealing web experiences,
                     and I’m always eager to learn and grow in the tech space.</p>
            <motion.ul 
            initial={{opacity: 0}} 
        whileInView={{opacity: 1}}
